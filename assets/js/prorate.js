// Prorate Calculator Pro Landing Page
...
function initBillingToggle() {
    ...
    function update() {
        ...
        if (isAnnual) {
            price.innerHTML = '$19.99 <span>/yr</span>';
            if (trial) trial.classList.remove('disabled');
        } else {
            price.innerHTML = '$2.99 <span>/mo</span>';
...
function initMultiSectionNav() {
    ...
    const sections = [
        { id: 'top', offset: 0 },
        { id: 'calculators', element: document.getElementById('calculators') },
